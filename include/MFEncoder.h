...
extern "C"
{
  typedef void (*EncoderEvent)(uint8_t eventId, uint8_t pin, const __FlashStringHelper *name);
};
...
{
public:
  MFEncoder(uint8_t pin1 = 0, uint8_t pin2 = 1, uint8_t TypeEncoder = 0, const __FlashStringHelper *name = nullptr);
